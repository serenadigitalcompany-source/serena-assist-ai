...
function WhatsAppIcon({ size = 18 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" aria-hidden>
      ...
      <path
        fill="#fff"
        d="M16.02 7.2c-4.86 0-8.8 3.94-8.8 8.8 0 1.55.41 3.06 1.18 4.39L7.2 24.8l4.53-1.18a8.78 8.78 0 0 0 4.29 1.1h.01c4.85 0 8.79-3.94 8.79-8.8a8.74 8.74 0 0 0-2.57-6.22 8.74 8.74 0 0 0-6.23-2.5zm0 16.03h-.01c-1.3 0-2.58-.35-3.7-1.01l-.26-.16-2.69.7.72-2.62-.17-.27a7.3 7.3 0 0 1-1.12-3.9 7.32 7.32 0 1 1 7.23 7.26zm4.01-5.44c-.22-.11-1.3-.64-1.5-.72-.2-.07-.35-.11-.5.11-.14.22-.56.72-.69.87-.13.14-.25.16-.47.05-.22-.11-.93-.34-1.77-1.09-.65-.58-1.09-1.3-1.22-1.52-.13-.22-.01-.34.1-.45.1-.1.22-.25.33-.38.11-.13.15-.22.22-.36.07-.15.04-.27-.02-.38-.05-.11-.5-1.2-.68-1.64-.18-.43-.36-.37-.5-.38h-.42c-.14 0-.38.05-.58.27-.2.22-.76.75-.76 1.82s.78 2.11.89 2.26c.11.14 1.54 2.35 3.72 3.3.52.22.93.36 1.24.46.52.17 1 .14 1.37.09.42-.06 1.3-.53 1.48-1.05.18-.51.18-.95.13-1.04-.06-.09-.2-.14-.42-.25z"
      />
    </svg>
  );
}
